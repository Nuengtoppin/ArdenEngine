...
## **6.4. База для DYN-контейнеров и сложных фигур**

Хотя сам раздел Rotation **не описывает** DYN-контейнеры, он даёт им готовую базу:

1. **Якорь контейнера**

   * DYN-контейнер может иметь Route (Region/Block/Chunk/…),
...
> единый “язык поворотов” для будущих DYN-контейнеров
