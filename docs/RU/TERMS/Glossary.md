...
## **DYN — Dynamic Container / динамический контейнер** (концептуально)

**Описание:** подвижный атомарный контейнер, который перемещается по миру как целое и несёт внутри себя локальные воксели и собственный AABB. Воксели внутри неподвижны — двигается только контейнер.
**Аналоги:** близко к «flying chunk» или dynamic rigidbody, но структурно самостоятельный тип контейнера.
